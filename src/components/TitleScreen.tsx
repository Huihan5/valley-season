  ...
  return (
    <div className="h-screen bg-bg text-game-text flex flex-col items-center justify-center gap-10 p-6">
      <div className="text-center space-y-3">
        <h1 className="text-gold font-serif text-4xl tracking-[0.3em]">河谷季</h1>
        <div className="w-24 h-px bg-gold-dim mx-auto" />
        <p className="text-cream-dim font-serif text-xs tracking-[0.35em]">VALLEY SEASON</p>
        <p className="text-game-dim text-xs pt-2">瓦莱维斯普公国 · 枫径庄园 · 三十天</p>
      </div>
